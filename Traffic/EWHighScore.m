...
#import "EWHighScore.h"
#import "EWAppDelegate.h"

@interface EWHighScore ()

@end

@implementation EWHighScore
...
- (void)viewDidLoad
{
    ...
    highScore = [delegate getHighScore];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSNumber* value = [highScore objectAtIndex: ([highScore count]-1) - indexPath.row];
    NSString* cellValue = [NSString stringWithFormat:@"%@", value];
